...
public class UtilSocketMode {
	public static final String ipAddress ="127.0.0.1";
	public static final int port = 8090;
	public static final int BUFFERSIZE= 1024;
	
	public static final int LOGIN_MOD=1;
	public static final int SIGNUP_MOD=2;
	
	public static final int CHATTING_MTM_MOD=21;
	public static final int MAKEROOM_MOD=22;
	public static final int ENTERROOM_MOD=23;
	...
	public static final int PUT_STONE_MOD = 37;
	public static final int END_GAME_MOD = 38;
	
	public static final int DRAW_REQUEST_MOD= 35;
	public static final int DROP_OUT_GAME_MOD = 36;
	
	public static final int CLOSE_MOD =100;
